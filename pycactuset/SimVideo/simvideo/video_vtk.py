...
def vtk_options(parser, antialias=0, background_color='k',
     shade_volume=True):
  parser = parser.add_argument_group('VTK options')
  parser.add_argument('--antialias', type=int, 
      metavar='<int>', default=antialias,
      help="How many antialias samples (0=off) (default is %(default)s).")
  ...
  parser.set_defaults(shade_volume=shade_volume)    
...
def horizon_options(parser, color='k', alpha=1):
  ...
  parser.add_argument('--ah-time-tol', type=float, default=0.1,
